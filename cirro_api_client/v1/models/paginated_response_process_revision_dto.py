...
class PaginatedResponseProcessRevisionDto:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_response_process_revision_dto = cls(
            data=data,
            next_token=next_token,
        )

        paginated_response_process_revision_dto.additional_properties = d
        return paginated_response_process_revision_dto

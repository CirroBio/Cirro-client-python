...
class DatasetFile(BaseModel):
    ...
    metadata: Optional[Dict[str, StrictStr]] = Field(default=None, description="Metadata associated with the file")
    __properties: ClassVar[List[str]] = ["path", "size", "metadata"]

...
class AuditEvent:
    ...
    Attributes:
        ...
        event_detail (Union[Unset, AuditEventEventDetail]): The details of the event, such as the request details sent
            from the client
        changes (Union[Unset, AuditEventChanges]): The changes made to the entity (if applicable) Example:
